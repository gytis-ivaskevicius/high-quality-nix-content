...
with authors; [
  ...
  { author = gkaply532; source = ./sources/nix-glow.blend; image = ./nix-glow-black.png; }
  { author = gkaply532; source = ./sources/nix-glow.blend; image = ./nix-glow-gruvbox.png; }
  ...
  { author = papojari; source = ./sources/nix-3d-showcase.blend; image = ./nix-3d-showcase.png; }
  { author = pl-misuw; image = ./nix-bazel.mp4; }
  { author = pl-misuw; image = ./nix.mp4; }
